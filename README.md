...
To reset (delete the older(s) and save the new one(s)) with http send a post with templates in body to `http://localhost:9876/v15.0/:phone/templates`, change :phone by your phone session number and put content of env UNOAPI_AUTH_TOKEN in Authorization header:
